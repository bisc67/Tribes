...
#endif
//-----------------------------------------------------------------------------
s32 gcncontainer_Load(char *pName,s32 *pCfxCount)
{
    container           *pContainer,*pLast;
    ...
    //
    pLast = g_gcnAudio.m_pContainers;
    while (pLast)
    {
    ...
    for (i=0;i<Header.m_Count;i++)
    {
        ...
        case CFXTYPE_ELEMENT:
            ...
            pElement->m_Length -= sizeof(adpcm_hdr);
    ...
    pContainer->m_pNext = g_gcnAudio.m_pContainers;
    g_gcnAudio.m_pContainers = pContainer;
    {
...
s32 gcncontainer_Unload(s32 containerid)
{
    ...
    pContainer = g_gcnAudio.m_pContainers;
    ...
    {
        g_gcnAudio.m_pContainers = pContainer->m_pNext;
    }
    //
...
//-----------------------------------------------------------------------------
cfx_element *gcncontainer_Find(s32 identifier)
{
    s32 ContainerId;
    container *pContainer;
...
//-----------------------------------------------------------------------------
f32 gcncontainer_GetVolume(s32 ContainerId)
{
