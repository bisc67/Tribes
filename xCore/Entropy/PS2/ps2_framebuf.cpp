             ...
             short zbp, short ztest, short zpsm, short clear) 
{
  ...
  sceGsSetDefClear(&buff->clearSmall0, ztest, 2048-(w>>1), 2048-(h>>1), w, h, 0,0,0, 0, 0);   
  ...
  sceGsSetDefClear(&buff->clearSmall1, ztest, 2048-(w>>1), 2048-(h>>1), w, h, 0,0,0, 0, 0);   
}
...
void SetDispBuffers(fsAABuff *buff, short w, short h, short psm, short fbp0, short fbp1)
{
  ...
  sceGsSetDefDispEnv((sceGsDispEnv*)(&buff->disp0), psm, w, h, s_XOff, s_YOff); // dx,dy = 0
  ...
  *((u_long*)&buff->disp0.display1) = *(u_long*)&buff->disp0.display;  
  ...
  // Buffer 1 ==================================================
  sceGsSetDefDispEnv((sceGsDispEnv*)(&buff->disp1), psm, w, h, s_XOff, s_YOff); // dx,dy = 0
