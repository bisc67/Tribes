// xTB.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CXTBApp, CWinApp)
	//{{AFX_MSG_MAP(CXTBApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CXTBApp object

CXTBApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CXTBApp construction
...
/////////////////////////////////////////////////////////////////////////////
// CXTBApp initialization

BOOL CXTBApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CXTBApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_XTB_DESCRIPTION);
