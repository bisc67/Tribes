...
char* pINI = 
    ...
    "c_include_path          =@/SN/include;@/Nintendo/include\n"
    "library_path            =@/SN/lib\n"
    "assembler_path          =@/SN/bin\n"
    "linker_path             =@/SN/bin\n"   
    "cplus_include_path      =@/SN/include/STLport-4.5/stlport;@/SN/include;@/Nintendo/include;@/SN\n"
...
int CompileSourceCode( void )
{
    ...
    //rintf( pNewRFile, " -fno-exceptions \n" );   // Disable exceptions
    fprintf( pNewRFile, " -fexceptions    \n" );   // Enable exceptions
...
int Linker( void )
{
    ...
    fprintf( pLRF, " --end-group -T ngc.ld \n" );
