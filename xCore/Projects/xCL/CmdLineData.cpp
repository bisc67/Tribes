...
{   
    ...
    if     ( m_TargetString[0]                          == 0 )      m_Target = TARGET_UNKNOWN;
    else if( strncmp( m_TargetString+6, "_PC",      3 ) == 0 )      m_Target = TARGET_PC;
    else if( strncmp( m_TargetString+6, "_PS2_IOP", 8 ) == 0 )      m_Target = TARGET_PS2_IOP;
    else if( strncmp( m_TargetString+6, "_PS2",     4 ) == 0 )      m_Target = TARGET_PS2;
    else if( strncmp( m_TargetString+6, "_XBOX",    5 ) == 0 )      m_Target = TARGET_XBOX;
    else if( strncmp( m_TargetString+6, "_GCN",     4 ) == 0 )      m_Target = TARGET_GCN;
    ...
    if( (m_Target == TARGET_UNKNOWN) && (m_Vendor == VENDOR_UNKNOWN) )
    {
        m_Target = TARGET_PC;
        m_Vendor = VENDOR_MS;
    }
