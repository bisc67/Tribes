...
CASCADE_ADD     MACRO A,B,C
                ...
                ELSE
                  ...
                  fld DWORD PTR es:[esi+(A*4)]
                  fld DWORD PTR es:[esi+(B*4)]
                  fld DWORD PTR es:[esi+(C*4)]
                  fadd st,st(1)
                  fxch st(1)
                  faddp st(2),st
                  fstp DWORD PTR es:[esi+(C*4)]
                  fstp DWORD PTR es:[esi+(B*4)]
...
IDCT_9          MACRO src,dest
                ...
                IFDEF AMD
                  ...
                  movd mm6,es:[esi+((src+0)*4)]
                  movd mm7,es:[esi+((src+12)*4)]
                  pfadd mm6,mm6
                  pfadd mm7,mm6
                  ...
                  movd mm0,es:[esi+((src+4)*4)]
                  movd mm1,es:[esi+((src+8)*4)]
                  movd mm2,es:[esi+((src+12)*4)]
                  movd mm3,es:[esi+((src+16)*4)]

                  movq mm4,mm6
                  movd mm5,es:[esi+((src+0)*4)]
                  pfadd mm4,mm0
                  pfsub mm5,mm0
                  pfsub mm4,mm1
                  pfadd mm5,mm1
                  ...
                  movd mm0,es:[esi+((src+2)*4)]
                  movd mm1,es:[esi+((src+10)*4)]
                  movd mm2,es:[esi+((src+14)*4)]
                  movd mm3,dct9t9
                  pfsub mm0,mm1
                  pfsub mm0,mm2
                  pfmul mm0,mm3
                ...
                ELSE 
                  ...
                  fld DWORD PTR es:[esi+((src+0)*4)]
                  fadd st,st(0)
                  fst a
                  fadd DWORD PTR es:[esi+((src+12)*4)]
                  fstp b
                  ...
                  fld a
                  fadd DWORD PTR es:[esi+((src+4)*4)]
                  fsub DWORD PTR es:[esi+((src+8)*4)]
                  fsub DWORD PTR es:[esi+((src+12)*4)]
                  fsub DWORD PTR es:[esi+((src+12)*4)]
                  fsub DWORD PTR es:[esi+((src+16)*4)]
                  fstp DWORD PTR [edi+((dest+1)*4)]
                  
                  fld DWORD PTR es:[esi+((src+0)*4)]
                  fsub DWORD PTR es:[esi+((src+4)*4)]
                  fadd DWORD PTR es:[esi+((src+8)*4)]
                  fsub DWORD PTR es:[esi+((src+12)*4)]
                  fadd DWORD PTR es:[esi+((src+16)*4)]
                  fstp DWORD PTR [edi+((dest+4)*4)]
                  
                  fld DWORD PTR es:[esi+((src+6)*4)]
                  fmul dct9t9
                  fst a
                  fchs
                  fstp b
                  ...
                  fld DWORD PTR es:[esi+((src+2)*4)]
                  fsub DWORD PTR es:[esi+((src+10)*4)]
                  fsub DWORD PTR es:[esi+((src+14)*4)]
                  fmul dct9t9
...
WINDOW_0110     MACRO A,B,C,D,E,F,G,H
                ...
                ELSE
                  ...
                  fchs
                  fmul DWORD PTR fs:[esi+(C*4)]
                  fadd DWORD PTR gs:[ecx+(D*4)]
                  fxch st(1)

                  fmul DWORD PTR fs:[esi+(G*4)]
                  fsub DWORD PTR gs:[ecx+(H*4)]
                  fstp DWORD PTR es:[edi+(E*4)]
                  fstp DWORD PTR es:[edi+(A*4)]
...
MULT            MACRO m1,m2,p1
                ...
                IFDEF AMD
cProc             AMD_IMDCT_1x36,<PUBLIC,FAR>,<si,di,bx,ds,es>
                ELSE
cProc             x86_IMDCT_1x36,<PUBLIC,FAR>,<si,di,bx,ds,es>
                ENDIF
                parmD lpIn
                parmD dwSB
                parmD lpResult
...
cBegin
                ...
                ELSE
                  ...
                  fld DWORD PTR es:[esi+(1*4)]
                  fadd DWORD PTR es:[esi+(0*4)]
                  fstp DWORD PTR es:[esi+(1*4)]
...
__save:         MULT_PAIR [ebx+(8*4)], fs:[esi+(18*4)], gs:[ecx+(0*4)],\
                          [ebx+(7*4)], fs:[esi+(19*4)], gs:[ecx+(1*4)]
                MULT_PAIR [ebx+(6*4)], fs:[esi+(20*4)], gs:[ecx+(2*4)],\
                          [ebx+(5*4)], fs:[esi+(21*4)], gs:[ecx+(3*4)]
                MULT_PAIR [ebx+(4*4)], fs:[esi+(22*4)], gs:[ecx+(4*4)],\
                          [ebx+(3*4)], fs:[esi+(23*4)], gs:[ecx+(5*4)]
                MULT_PAIR [ebx+(2*4)], fs:[esi+(24*4)], gs:[ecx+(6*4)],\
                          [ebx+(1*4)], fs:[esi+(25*4)], gs:[ecx+(7*4)]
                MULT_PAIR [ebx+(0*4)], fs:[esi+(26*4)], gs:[ecx+(8*4)],\
                          [ebx+(0*4)], fs:[esi+(27*4)], gs:[ecx+(9*4)]
                MULT_PAIR [ebx+(1*4)], fs:[esi+(28*4)], gs:[ecx+(10*4)],\
                          [ebx+(2*4)], fs:[esi+(29*4)], gs:[ecx+(11*4)]
                MULT_PAIR [ebx+(3*4)], fs:[esi+(30*4)], gs:[ecx+(12*4)],\
                          [ebx+(4*4)], fs:[esi+(31*4)], gs:[ecx+(13*4)]
                MULT_PAIR [ebx+(5*4)], fs:[esi+(32*4)], gs:[ecx+(14*4)],\
                          [ebx+(6*4)], fs:[esi+(33*4)], gs:[ecx+(15*4)]
                MULT_PAIR [ebx+(7*4)], fs:[esi+(34*4)], gs:[ecx+(16*4)],\
                          [ebx+(8*4)], fs:[esi+(35*4)], gs:[ecx+(17*4)]
...
IDCT_3          MACRO in1,in2,in3,out1,out2,out3
                ...
                IFDEF AMD
cProc             AMD_IMDCT_3x12,<PUBLIC,FAR>,<si,di,bx,ds,es>
                ELSE
cProc             x86_IMDCT_3x12,<PUBLIC,FAR>,<si,di,bx,ds,es>
                ENDIF
                parmD lpIn
                parmD dwSB
                parmD lpResult
...
__for_DCT:      ACCUM_PAIR fs:[esi+(5*4)], fs:[esi+(4*4)], fs:[esi+(4*4)], fs:[esi+(3*4)]
                ACCUM_PAIR fs:[esi+(3*4)], fs:[esi+(2*4)], fs:[esi+(2*4)], fs:[esi+(1*4)]
                ACCUM_PAIR fs:[esi+(1*4)], fs:[esi+(0*4)], fs:[esi+(5*4)], fs:[esi+(3*4)]
                ACCUM      fs:[esi+(3*4)], fs:[esi+(1*4)]

                IDCT_3 fs:[esi+(4*4)], fs:[esi+(2*4)], fs:[esi+(0*4)], temp[1*4], temp[0*4], temp[2*4]
                IDCT_3 fs:[esi+(5*4)], fs:[esi+(3*4)], fs:[esi+(1*4)], temp[4*4], temp[5*4], temp[3*4]
...
__odd_overlap:  
                ...
                REPT 9
                  ...
                  fld DWORD PTR [esi+I]
                  fadd DWORD PTR fs:[ebx+I]
                  fstp DWORD PTR es:[edi+I]
                
                  fld DWORD PTR [esi+SIZE DWORD+I]
                  fchs
                  fsub DWORD PTR fs:[ebx+SIZE DWORD+I]
                  fstp DWORD PTR es:[edi+SIZE DWORD+I]
...
__overlap_done: add ebx,18 * SIZE DWORD
                ...
                REPT 18
                  ...
                  fld DWORD PTR [esi+I]
                  fstp DWORD PTR fs:[ebx+I-(18 * SIZE DWORD)]
...
REORD_PAIR      MACRO stride,dest1,A,B,C,D,dest2,E,F,G,H
                ...
                movd mm1,DWORD PTR fs:[esi+(A*stride*4)]
                movd mm3,DWORD PTR fs:[esi+(C*stride*4)]
                movd mm4,DWORD PTR [ebx+(D*4)]
                movq mm2,mm1
                pfsub mm1,mm3

                movd mm5,DWORD PTR fs:[esi+(C*stride*4)]
                movd mm6,DWORD PTR fs:[esi+(G*stride*4)]
                ...
                movd mm1,DWORD PTR fs:[esi+(E*stride*4)]
                movd mm7,DWORD PTR [ebx+(H*4)]
                movq mm2,mm1
                pfsub mm1,mm6
                movd mm0,DWORD PTR fs:[esi+(G*stride*4)]
...
REORD_PAIR      MACRO stride,dest1,A,B,C,D,dest2,E,F,G,H
                ...
                fld DWORD PTR fs:[esi+(E*stride*4)]    
                fdup
                fld DWORD PTR fs:[esi+(A*stride*4)]    
                fdup                            

                fsub DWORD PTR fs:[esi+(C*stride*4)]   
                fmul DWORD PTR [ebx+(D*4)]
                fxch st(2)                     
                fsub DWORD PTR fs:[esi+(G*stride*4)]   
                fmul DWORD PTR [ebx+(H*4)]
                fxch st(2)                     

                fstp DWORD PTR [edi+(B*4)]
                fadd DWORD PTR fs:[esi+(C*stride*4)]
                fstp DWORD PTR [edi+(dest1*4)]

                fstp DWORD PTR [edi+(F*4)]
                fadd DWORD PTR fs:[esi+(G*stride*4)]
                ...
                IFDEF AMD
cProc             AMD_poly_filter,<PUBLIC,FAR>,<si,di,bx,ds,es>
                ELSE
cProc             x86_poly_filter,<PUBLIC,FAR>,<si,di,bx,ds,es>
                ENDIF
                parmD lpSrc
                parmD lpBArray
                parmD dwPhase
...
cBegin
                ...
                IFDEF AMD
                  ...
                  movd mm1,[esi+(9*4)]
                  movd mm2,[esi+(14*4)]
                  movd es:[edi+(0*16*4)],mm0
                  pfsub mm1,mm2
                  movd es:[edi+(2*16*4)],mm1
                  ...
                  pfsub mm0,mm2
                  pfsub mm1,mm3
                  movd es:[edi+(4*16*4)],mm0
                  movd es:[edi+(6*16*4)],mm1
                  ...
                  movd mm5,[esi+(13*4)]
                  pfsub mm1,mm4
                  movd es:[edi+(8*16*4)],mm0
                  pfsub mm1,mm5
                  movd es:[edi+(12*16*4)],mm2
                  movd es:[edi+(10*16*4)],mm1

                  movd mm0,[esi+(15*4)]
                  movd mm1,[esi+(0*4)]
                  movd es:[edi+(14*16*4)],mm0

                  xor edi,edi
                  les di,[lpOut2]

                  pxor mm6,mm6
                  movd es:[edi+(16*16*4)],mm1
                  ...
                  movd es:[edi+(8*16*4)],mm0
                  pfsub mm3,mm5
                  movd es:[edi+(12*16*4)],mm1
                  movd es:[edi+(6*16*4)],mm3
                  ...
                  pfsubr mm3,mm6
                  movd es:[edi+(4*16*4)],mm0
                  movd es:[edi+(2*16*4)],mm2
                  movd es:[edi+(0*16*4)],mm3
                ...
                ELSE
                  ...
                  fstp DWORD PTR es:[edi+(0*16*4)]

                  fld DWORD PTR [esi+(9*4)]
                  fsub DWORD PTR [esi+(14*4)]
                  fstp DWORD PTR es:[edi+(2*16*4)]

                  fld DWORD PTR [esi+(5*4)]
                  fsub DWORD PTR [esi+(6*4)]
                  fstp DWORD PTR es:[edi+(4*16*4)]

                  fld DWORD PTR [esi+(13*4)]
                  fsub DWORD PTR [esi+(10*4)]
                  fstp DWORD PTR es:[edi+(6*16*4)]

                  fld DWORD PTR [esi+(3*4)]
                  fstp DWORD PTR es:[edi+(8*16*4)]

                  fld DWORD PTR [esi+(11*4)]
                  fsub DWORD PTR [esi+(8*4)]
                  fsub DWORD PTR [esi+(9*4)]
                  fsub DWORD PTR [esi+(13*4)]
                  fstp DWORD PTR es:[edi+(10*16*4)]

                  fld DWORD PTR [esi+(7*4)]
                  fstp DWORD PTR es:[edi+(12*16*4)]

                  fld DWORD PTR [esi+(15*4)]
                  fstp DWORD PTR es:[edi+(14*16*4)]

                  xor edi,edi
                  les di,[lpOut2]

                  fld DWORD PTR [esi+(0*4)]
                  fstp DWORD PTR es:[edi+(16*16*4)]
                ...
                fchs
                fstp DWORD PTR es:[edi+(1*16*4)]

                fld DWORD PTR [esi+(26*4)]
                fsub DWORD PTR [esi+(22*4)]
                fstp DWORD PTR es:[edi+(3*16*4)]

                fld DWORD PTR [esi+(18*4)]
                fadd DWORD PTR [esi+(20*4)]
                fsub DWORD PTR [esi+(26*4)]
                fstp DWORD PTR es:[edi+(5*16*4)]

                fld DWORD PTR [esi+(28*4)]
                fsub DWORD PTR [esi+(18*4)]
                fstp DWORD PTR es:[edi+(7*16*4)]

                fld DWORD PTR [esi+(28*4)]
                fchs
                fstp DWORD PTR es:[edi+(9*16*4)]

                fld DWORD PTR [esi+(24*4)]
                fsub DWORD PTR [esi+(20*4)]
                fstp DWORD PTR es:[edi+(11*16*4)]

                fld DWORD PTR [esi+(16*4)]
                fsub DWORD PTR [esi+(24*4)]
                fstp DWORD PTR es:[edi+(13*16*4)]

                fld DWORD PTR [esi+(16*4)]
                fchs
                fstp DWORD PTR es:[edi+(15*16*4)]
...
__done:
                ...
                IFDEF AMD
cProc             AMD_dewindow_and_write,<PUBLIC,FAR>,<si,di,bx,ds,es>
                ELSE
cProc             x86_dewindow_and_write,<PUBLIC,FAR>,<si,di,bx,ds,es>
                ENDIF
                parmD lpU
                parmD lpDewindow
                parmD dwStart
...
__for_loops:    MAC_INIT_PAIR fs:[esi],gs:[ebx],fs:[esi+4],gs:[ebx+4]

                CNT = 8
                REPT 7

                  MAC_PAIR fs:[esi+CNT],gs:[ebx+CNT],fs:[esi+CNT+4],gs:[ebx+CNT+4]
                ...
                MAC_INIT_PAIR fs:[esi],gs:[ebx],fs:[esi+8],gs:[ebx+8]

                CNT = 16
                REPT 3

                  MAC_PAIR fs:[esi+CNT],gs:[ebx+CNT],fs:[esi+CNT+8],gs:[ebx+CNT+8]
...
__odd_loops:    sub esi,16*4
                ...
                MAC_INIT_PAIR fs:[esi+ASCEND+4],gs:[ebx+DESCEND-4],fs:[esi+ASCEND],gs:[ebx+DESCEND]
                ...
                REPT 7
                  ...
                  MAC_PAIR fs:[esi+ASCEND+4],gs:[ebx+DESCEND-4],fs:[esi+ASCEND],gs:[ebx+DESCEND]
...
__even_segment:
                MAC_INIT_PAIR fs:[esi+4],gs:[ebx+4],fs:[esi+12],gs:[ebx+12]

                CNT = 16
                REPT 3

                  MAC_PAIR fs:[esi+CNT+4],gs:[ebx+CNT+4],fs:[esi+CNT+12],gs:[ebx+CNT+12]
...
__even_loops:   sub esi,16*4
                ...
                MAC_INIT_PAIR fs:[esi+ASCEND],gs:[ebx+DESCEND],fs:[esi+ASCEND+4],gs:[ebx+DESCEND-4]
                ...
                REPT 7
                  ...
                  MAC_PAIR fs:[esi+ASCEND],gs:[ebx+DESCEND],fs:[esi+ASCEND+4],gs:[ebx+DESCEND-4]
