...
#define MSS_VERSION      "6.1c"
#define MSS_MAJOR_VERSION 6
#define MSS_MINOR_VERSION 1
#define MSS_SUB_VERSION   3
#define MSS_VERSION_DATE "15-Oct-01"
...
#define DEFAULT_DDFS               2      // Use 2 millisecond buffer fragments with Sound Manager

#define DIG_DS_FRAGMENT_CNT        35
#define DEFAULT_DDFC               96     // Use 96 buffer fragments with Sound Manager

#define DIG_DS_MIX_FRAGMENT_CNT    42
#define DEFAULT_DDMFC              8      // Mix ahead 4 buffer fragments
