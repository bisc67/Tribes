...
#ifdef TARGET_PC
inline f32 x_sqrt  ( f32 a )        { return(                (f32)(sqrt ( (f64)a ) ) ); }
inline f32 x_1sqrt ( f32 a )        { return(         1.0f / (f32)(sqrt ( (f64)a ) ) ); }
inline f32 x_log   ( f32 a )        { return(                (f32)(log  ( (f64)a ) ) ); }
inline f32 x_log2  ( f32 a )        { return( 1.442695041f * (f32)(log  ( (f64)a ) ) ); }
inline f32 x_log10 ( f32 a )        { return(                (f32)(log10( (f64)a ) ) ); }
inline f32 x_exp   ( f32 a )        { return(                (f32)(exp  ( (f64)a ) ) ); }
inline f32 x_pow   ( f32 a, f32 b ) { return(                (f32)(pow  ( (f64)a, (f64)b ) ) ); }

inline f32 x_tan   ( f32 a )        { return(                (f32)(tan  ( (f64)a ) ) ); }
inline f32 x_atan  ( f32 a )        { return(                (f32)(atan ( (f64)a ) ) ); }
inline f32 x_asin  ( f32 a )        { return(                (f32)(asin ( (f64)a ) ) ); }
inline f32 x_acos  ( f32 a )        { return(                (f32)(acos ( (f64)a ) ) ); }
#endif
...
//#if defined(TARGET_PS2_IOP)
	inline f32 x_sqrt  ( f32 a )        { return(				 a ); }
	inline f32 x_1sqrt ( f32 a )        { return(				 a ); }
	inline f32 x_log   ( f32 a )        { return(                a ); }
	inline f32 x_log2  ( f32 a )        { return(                a ); }
	inline f32 x_log10 ( f32 a )        { return(                a ); }
	inline f32 x_exp   ( f32 a )        { return(                a ); }
	inline f32 x_pow   ( f32 a, f32 b ) { return(                a+b ); }

	inline f32 x_tan   ( f32 a )        { return(                a ); }
	inline f32 x_atan  ( f32 a )        { return(                a ); }
	inline f32 x_asin  ( f32 a )        { return(                a ); }
	inline f32 x_acos  ( f32 a )        { return(                a ); }
#else
